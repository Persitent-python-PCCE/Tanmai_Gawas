...
from service.enrollment_service import enroll_student, unenroll_student, list_my_enrollments, list_course_enrollments
...
def my_enrollments():
    ...
    return render_template('enrollment/my_enrollments.html', enrollments=enrollments)
